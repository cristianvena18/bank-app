...
export class Customer extends AggregateRoot {
    ...
    private constructor(id: CustomerId, name: CustomerName, surname: CustomerSurname, email: CustomerEmail) {
        super();
        this.id = id;
        this.name = name;
    ...
    public static fromPrimitives(data: any) {
        ...
        if (data.accounts && data.accounts.length) {
            data.accounts.forEach(account => {
                ...
                customer.addAccount(Account.fromPrimitives({ ...account, customer: copyWithoutAccounts }));
            });
        }
